#!/bin/bash
# Original: https://raw.githubusercontent.com/ricmmartins/apache-guacamole-azure/main/guac-install.sh
...
guacmysqlhostname="mysqlsvr.mysql.database.azure.com"
guacmysqlport="3306"
guacmysqldatabase="mysqldb"
guacmysqlusername="mysqladmin@mysqlsvr"
...
ghostscript wget dpkg-dev nginx-core
